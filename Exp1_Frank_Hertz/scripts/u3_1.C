void u3_1(){
  ...
  ifstream file;
  file.open("../data/analysis_data/U1(1,75)U3(0,28)T(174).txt");
  ...
  TF1 *gauss_0 = new TF1("gauss_0", "gaus", 4.-adj_par, 6.-adj_par); 
  gauss_0->SetLineWidth(3);
  gauss_0->SetLineColor(kGreen);
  gr->Fit(gauss_0, "R");

  TF1 *gauss_1 = new TF1("gauss_1", "gaus", 8.9-adj_par, 10.9-adj_par);
  gauss_1->SetLineWidth(3);
  gauss_1->SetLineColor(kGreen);
  gr->Fit(gauss_1, "R+");

  TF1 *gauss_2 = new TF1("gauss_2", "gaus", 14.1-adj_par, 15.6-adj_par);
  gauss_2->SetLineWidth(3);
  gauss_2->SetLineColor(kGreen);
  gr->Fit(gauss_2, "R+");

  TF1 *gauss_3 = new TF1("gauss_3", "gaus", 18.9-adj_par, 20.9-adj_par); 
  gauss_3->SetLineWidth(3);
  gauss_3->SetLineColor(kGreen);
  gr->Fit(gauss_3, "R+");

  TF1 *gauss_4 = new TF1("gauss_4", "gaus", 24.-adj_par, 26.-adj_par);
  gauss_4->SetLineWidth(3);
  gauss_4->SetLineColor(kGreen);
  gr->Fit(gauss_4, "R+");

  TF1 *gauss_5 = new TF1("gauss_5", "gaus", 29.4-adj_par, 31.3-adj_par);
