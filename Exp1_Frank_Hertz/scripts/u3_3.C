void u3_3(){
  ...
  ifstream file;
  file.open("../data/analysis_data/U1(1,75)U3(0,74)T(175).txt");
  ...
  TF1 *gauss_1 = new TF1("gauss_1", "gaus", 8.8-adj_par, 10.8-adj_par);
  ...
  TF1 *gauss_5 = new TF1("gauss_5", "gaus", 28.7-adj_par, 32.-adj_par);
