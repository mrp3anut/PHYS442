void u3_2(){
  ...
  ifstream file;
  file.open("../data/analysis_data/U1(1,75)U3(0,49)T(174).txt");
  ...
  TF1 *gauss_3 = new TF1("gauss_3", "gaus", 18.8-adj_par, 20.8-adj_par); 
  gauss_3->SetLineWidth(3);
  gauss_3->SetLineColor(kGreen);
  gr->Fit(gauss_3, "R+");

  TF1 *gauss_4 = new TF1("gauss_4", "gaus", 24.1-adj_par, 26.1-adj_par);
