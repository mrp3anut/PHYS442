void t3(){
  ...
  ifstream file;
  file.open("../data/analysis_data/U1(2,24)U3(1,05)T(200).txt");
  ...
  TF1 *gauss_0 = new TF1("gauss_0", "gaus", 4.5-adj_par, 5.5-adj_par); 
  ...
  TF1 *gauss_2 = new TF1("gauss_2", "gaus", 13.8-adj_par, 15.3-adj_par);
  gauss_2->SetLineWidth(3);
  gauss_2->SetLineColor(kGreen);
  gr->Fit(gauss_2, "R+");

  TF1 *gauss_3 = new TF1("gauss_3", "gaus", 18.6-adj_par, 20.5-adj_par); 
